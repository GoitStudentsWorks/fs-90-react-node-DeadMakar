...
`,He=()=>{const{user:g}=ne(J=>J.auth);return p.jsxs(p.Fragment,{children:[p.jsx(Qe,{children:p.jsx("use",{href:`${q}#icon-settings-01`})}),p.jsx(Ye,{children:g!=null&&g.avatarURL?p.jsx(p.Fragment,{children:p.jsx(ze,{src:g.avatarURL,alt:"User Avatar"})}):p.jsx(Ue,{children:p.jsx("use",{href:`${q}#icon-gridicons_user`})})})]})},Fe=D.div`
  position: fixed;
  top: 0;
  left: 0;
...
`,Ze=D.span`
  ...
  line-height: 150%;
  color: ${B.colorWhite};
`,Ne=({onClick:g})=>{const J=_e(),K=()=>{J(we()),g()},X=Z=>{Z.code==="Escape"&&g()},Y=()=>{g()},z=Z=>{Z.currentTarget===Z.target&&g()};return ve.useEffect(()=>(window.addEventListener("keydown",X),()=>{window.removeEventListener("keydown",X)})),p.jsx(Fe,{onClick:z,children:p.jsxs(Be,{children:[p.jsx(Xe,{onClick:Y,children:p.jsx(Ke,{children:p.jsx("use",{href:`${q}#icon-x`})})}),p.jsxs(Ge,{children:[p.jsx(pe,{to:"/diary",onClick:Y,children:"Diary"}),p.jsx(pe,{to:"/products",onClick:Y,children:"Products"}),p.jsx(pe,{to:"/exercises",onClick:Y,children:"Exercises"})]}),p.jsxs(Je,{to:"/welcome",onClick:K,children:[p.jsx(Ze,{children:"Logout"}),p.jsx(Re,{children:p.jsx("use",{href:`${q}#icon-log-out-02`})})]})]})})},Ve=()=>{const[g,J]=ve.useState(!1),K=()=>{J(Z=>!Z)},X=ne(me),Y=ne(je),z=Y==null?void 0:Y.userMetrics;return p.jsxs(Ie,{children:[p.jsxs(Le,{children:[p.jsx(Ee,{to:"/",children:p.jsx(Pe,{})}),X&&z&&p.jsxs(ke,{children:[p.jsx(re,{minWidth:1440,children:p.jsxs($e,{children:[p.jsx(fe,{to:"/diary",activeclassname:"active",exact:"true",children:"Diary"}),p.jsx(fe,{to:"/products",activeclassname:"active",exact:"true",children:"Products"}),p.jsx(fe,{to:"/exercises",activeclassname:"active",exact:"true",children:"Exercises"})]})}),p.jsx(De,{to:"/profile",children:p.jsx(He,{})}),p.jsx(re,{minWidth:1440,children:p.jsx(Me,{})}),p.jsx(re,{maxWidth:1439,children:p.jsx(We,{onClick:K,children:p.jsx("use",{href:`${q}#icon-menu`})})})]})]}),p.jsx(re,{maxWidth:1439,children:g&&p.jsx(Ne,{onClick:K})})]})},rt=()=>{const g=Oe(),J=ne(me),K=["/diary","/profile","/products","/exercises"].some(X=>g.pathname.startsWith(X))||g.pathname==="/"&&J;return p.jsxs(p.Fragment,{children:[K&&p.jsx(Ve,{}),p.jsx(Te,{}),p.jsx(Ce,{})]})};export{rt as default};
