import{u as r,a,d as Z,b as ee,f as te,r as y,q as ce,t as ie,j as t,s as b,c as _,g as de,v as le,w as pe,B as T,x as xe,C as he}from"./index-2c14e649.js";import{T as ge}from"./TitlePage-af584fb3.js";import{b as me}from"./LogOutBtn-38ec26a2.js";import{c as ue,a as O,b as k,F as re,d as fe,e as be}from"./index.esm-395674e2.js";import{g as U,i as ye,a as ve}from"./index-1d437aa3.js";import"./floating-ui.dom-9d61e2db.js";const je=r.div`
  display: flex;
...
`;var Ne=Math.ceil,Ye=Math.max;function Me(e,i,n,c){for(var h=-1,l=Ye(Ne((i-e)/(n||1)),0),g=Array(l);l--;)g[c?l:++h]=e,e+=n;return g}var qe=Me;function Ge(e,i){return e===i||e!==e&&i!==i}var He=Ge,Qe=typeof _=="object"&&_&&_.Object===Object&&_,Ve=Qe,Xe=Ve,Je=typeof self=="object"&&self&&self.Object===Object&&self,Ke=Xe||Je||Function("return this")(),Ze=Ke,et=Ze,tt=et.Symbol,ne=tt,N=ne,ae=Object.prototype,it=ae.hasOwnProperty,rt=ae.toString,A=N?N.toStringTag:void 0;function nt(e){var i=it.call(e,A),n=e[A];try{e[A]=void 0;var c=!0}catch{}var h=rt.call(e);return c&&(i?e[A]=n:delete e[A]),h}var at=nt,ot=Object.prototype,st=ot.toString;function ct(e){return st.call(e)}var dt=ct,Y=ne,lt=at,pt=dt,xt="[object Null]",ht="[object Undefined]",M=Y?Y.toStringTag:void 0;function gt(e){return e==null?e===void 0?ht:xt:M&&M in Object(e)?lt(e):pt(e)}var oe=gt;function mt(e){var i=typeof e;return e!=null&&(i=="object"||i=="function")}var I=mt,ut=oe,ft=I,bt="[object AsyncFunction]",yt="[object Function]",vt="[object GeneratorFunction]",jt="[object Proxy]";function wt(e){if(!ft(e))return!1;var i=ut(e);return i==yt||i==vt||i==bt||i==jt}var kt=wt,At=9007199254740991;function St(e){return typeof e=="number"&&e>-1&&e%1==0&&e<=At}var _t=St,Ct=kt,Wt=_t;function $t(e){return e!=null&&Wt(e.length)&&!Ct(e)}var zt=$t,It=9007199254740991,Bt=/^(?:0|[1-9]\d*)$/;function Tt(e,i){var n=typeof e;return i=i??It,!!i&&(n=="number"||n!="symbol"&&Bt.test(e))&&e>-1&&e%1==0&&e<i}var Ot=Tt,Ut=He,Rt=zt,Dt=Ot,Et=I;function Lt(e,i,n){if(!Et(n))return!1;var c=typeof i;return(c=="number"?Rt(n)&&Dt(i,n.length):c=="string"&&i in n)?Ut(n[i],e):!1}var Ft=Lt,Pt=/\s/;function Nt(e){for(var i=e.length;i--&&Pt.test(e.charAt(i)););return i}var Yt=Nt,Mt=Yt,qt=/^\s+/;function Gt(e){return e&&e.slice(0,Mt(e)+1).replace(qt,"")}var Ht=Gt;function Qt(e){return e!=null&&typeof e=="object"}var Vt=Qt,Xt=oe,Jt=Vt,Kt="[object Symbol]";function Zt(e){return typeof e=="symbol"||Jt(e)&&Xt(e)==Kt}var ei=Zt,ti=Ht,q=I,ii=ei,G=0/0,ri=/^[-+]0x[0-9a-f]+$/i,ni=/^0b[01]+$/i,ai=/^0o[0-7]+$/i,oi=parseInt;function si(e){if(typeof e=="number")return e;if(ii(e))return G;if(q(e)){var i=typeof e.valueOf=="function"?e.valueOf():e;e=q(i)?i+"":i}if(typeof e!="string")return e===0?e:+e;e=ti(e);var n=ni.test(e);return n||ai.test(e)?oi(e.slice(2),n?2:8):ri.test(e)?G:+e}var ci=si,di=ci,H=1/0,li=17976931348623157e292;function pi(e){if(!e)return e===0?e:0;if(e=di(e),e===H||e===-H){var i=e<0?-1:1;return i*li}return e===e?e:0}var xi=pi,hi=qe,gi=Ft,W=xi;function mi(e){return function(i,n,c){return c&&typeof c!="number"&&gi(i,n,c)&&(n=c=void 0),i=W(i),n===void 0?(n=i,i=0):n=W(n),c=c===void 0?i<n?1:-1:W(c),hi(i,n,c,e)}}var ui=mi,fi=ui,bi=fi(),yi=bi;const vi=de(yi),ji=r.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  border-radius: 12px;
...
`,x=({name:e,value:i,text:n})=>t.jsxs($i,{children:[t.jsx(zi,{type:"radio",name:e,value:i}),t.jsx(Ii,{}),n]}),Bi=r.div`
  margin-top: 18px;
...
`,Hi=()=>t.jsx(he,{children:t.jsxs(Li,{children:[t.jsx(ge,{contentText:"Profile Settings"}),t.jsxs(Ei,{children:[t.jsx(Re,{}),t.jsx(Di,{})]})]})});export{Hi as default};
