import{r as p,u as M,a as b,a4 as $t,d as Pe,j as m,s as ee,H as Ae,O as jt,ab as oe,B as Me,ac as Ht,ad as Wt,ae as je,af as be,ag as Ut,ah as _t,ai as Nt,aj as zt,ak as Gt,y as Yt,al as qt,b as ae,f as Kt,am as Xt,an as Zt,C as Jt}from"./index-2c14e649.js";import{T as Qt}from"./TitlePage-af584fb3.js";import{h as en,E as tn,c as nn,s as rn,_ as w}from"./emotion-element-c39617d8.browser.esm-dbb139b1.js";import{e as on,F as ut,d as an}from"./index.esm-395674e2.js";import{b as un}from"./floating-ui.dom-9d61e2db.js";function sn(n,e){if(n==null)return{};var r={},o=Object.keys(n),t,a;for(a=0;a<o.length;a++)t=o[a],!(e.indexOf(t)>=0)&&(r[t]=n[t]);return r}var S=function(e,r){var o=arguments;if(r==null||!en.call(r,"css"))return p.createElement.apply(void 0,o);var t=o.length,a=new Array(t);a[0]=tn,a[1]=nn(e,r);for(var u=2;u<t;u++)a[u]=o[u];return p.createElement.apply(null,a)};function Ve(){for(var n=arguments.length,e=new Array(n),r=0;r<n;r++)e[r]=arguments[r];return rn(e)}var ln=function(){var e=Ve.apply(void 0,arguments),r="animation-"+e.name;return{name:r,styles:"@keyframes "+r+"{"+e.styles+"}",anim:1,toString:function(){return"_EMO_"+this.name+"_"+this.styles+"_EMO_"}}};function te(n){"@babel/helpers - typeof";return te=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},te(n)}function cn(n,e){if(te(n)!="object"||!n)return n;var r=n[Symbol.toPrimitive];if(r!==void 0){var o=r.call(n,e||"default");if(te(o)!="object")return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(n)}function st(n){var e=cn(n,"string");return te(e)=="symbol"?e:String(e)}function Oe(n,e){return Oe=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(o,t){return o.__proto__=t,o},Oe(n,e)}function dn(n){if(n===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return n}const pn="/fs-90-react-node-DeadMakar/assets/products-bg-b7e77cea.jpg",fn="/fs-90-react-node-DeadMakar/assets/products-bg@2x-9876be0a.jpg",hn=M.div`
  display: flex;
...
`,Mi=M.svg`
  ...
  height: 16px;
  margin-left: 8px;
`,Vi="/fs-90-react-node-DeadMakar/assets/avocado-46dd5bc9.png",ki=({calories:n,closeModalAddProductSuccess:e})=>m.jsxs(Fi,{children:[m.jsx(Oi,{src:Vi}),m.jsx(wi,{children:"Well done"}),m.jsxs(Di,{children:["Calories: ",m.jsx(Ii,{children:n})]}),m.jsx(Pi,{type:"button",onClick:()=>e(),children:"Next product"}),m.jsxs(Ai,{href:"/PowerPulseTeamPoject/diary",children:["to the Diary",m.jsx(Mi,{children:m.jsx("use",{href:`${ee}#icon-arrow`})})]})]}),Li=({products:n})=>{const e=ae(lt),[r,o]=p.useState(null),[t,a]=p.useState(!1),[u,l]=p.useState(null),i=f=>{a(!0),o(f),l(f),document.body.style.overflow="hidden"},s=()=>{t&&a(!1),o(null),l(null),document.body.style.overflow="visible"},d=ae(Kt).blood;return m.jsxs(m.Fragment,{children:[e&&m.jsx(Ae,{}),!e&&(n==null?void 0:n.length)>0&&m.jsx(si,{children:n.map(f=>m.jsx(pi,{product:f,type:f.groupBloodNotAllowed[d],handleOpenModal:i},f._id))}),!e&&(n==null?void 0:n.length)<=0&&m.jsxs(li,{children:[m.jsxs(ci,{children:[m.jsx("span",{children:"Sorry, no results were found"})," for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),m.jsx(di,{children:"Try changing the search parameters."})]}),r&&m.jsx(Xt,{isOpen:t,onRequestClose:s,children:typeof u=="object"?m.jsx(yi,{closeModallAddProductForm:s,calories:r.calories,productTitle:r.title,productId:r._id,product:u,onClick:i,productCategory:r.category}):m.jsx(ki,{calories:u,closeModalAddProductSuccess:s})})]})},Hi=()=>{const n=Pe(),e=ae(lt),r=ae(bn),o=ae(vn);return p.useEffect(()=>{(async()=>{try{await n(oe({title:"",category:null,groupBloodNotAllowed:"all"}))}catch{Me.error("Sorry, something went wrong, please try again",{theme:"dark"})}})()},[n]),p.useEffect(()=>{n(Zt())},[n]),m.jsx(hn,{children:m.jsxs(Jt,{children:[m.jsxs(mn,{children:[m.jsx(Qt,{contentText:"Products"}),m.jsx(ui,{categories:r})]}),e?m.jsx(Ae,{}):m.jsx(gn,{children:m.jsx(Li,{products:o})})]})})};export{Hi as default};
